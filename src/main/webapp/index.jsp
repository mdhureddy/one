...
<head>
    ...
    <title>NexusShop · Modern E‑Commerce123</title>
...
<body>
    ...
    <script>
        ...
        function renderProducts(list) {
            ...
            if (!list.length) {
                productsGrid.innerHTML = `<p style="grid-column:1/-1;text-align:center;padding:48px;color:var(--muted);font-size:16px;">No products found.</p>`;
                return;
            }
            list.forEach(p => {
